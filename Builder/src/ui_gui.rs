            ...
            egui::Frame::none()
                ...
                .show(ui, |ui| {
                    ...
                    ui.horizontal(|ui| {
                        ...
                        ui.add_space(6.0);
                        ui.vertical(|ui| {
                            ui.label(RichText::new(".env preserved from existing install").color(OK).size(13.0).strong());
                            ui.label(RichText::new(
                                "The builder rewrites config.yml from the full server example template.\n\
                                 Existing .env stays in place unless it is missing."
                            ).color(DIM).size(11.0));
                        });
                    });
                });
