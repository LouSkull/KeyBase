...
if (themeSelect) {
  try { themeSelect.value = localStorage.getItem('keybase-theme') || (window.matchMedia && window.matchMedia('(prefers-color-scheme: dark)').matches ? 'dark' : 'classic'); } catch (err) { themeSelect.value = 'classic'; }
